...
CONSUMER_KEY = os.environ[TWITTER_CONSUMER_KEY]=[XQFg5y1p8Oip9FBrhbTurLJgi]
CONSUMER_SECRET = os.environ[TWITTER_CONSUMER_SECRET]=[AqULlrIHiVRpdrhney3oTCz3nvF2pwet8TtekZaeiHwJMViOWF]
OAUTH_TOKEN = os.environ[TWITTER_OAUTH_TOKEN]=[2919355408-dojwwboWOfhN7AlbensdcwpDCTBfFpXtQK4n9zs]
OAUTH_TOKEN_SECRET = os.environ[TWITTER_OAUTH_TOKEN_SECRET]=[j3Pq7SAgdF01QykVOQC54YyvrehgvMC6Q12SzH2Bn3Pdv]
